...
Revision ID: 0f9eadb6382e
Revises: 
Create Date: 2023-12-01 09:44:14.846293
...
def upgrade():
    ...
    op.create_table('pixel_art_models',
    ...
    sa.ForeignKeyConstraint(['model_id'], ['pixel_art_models.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
